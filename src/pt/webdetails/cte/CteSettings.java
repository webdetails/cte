...
public class CteSettings extends PluginSettings {
  ...
  public CteSettings( IRWAccess writeAccess ) {
    ...
    blacklistedFolders = initBlacklistedFolders();
    blacklistedFileExtensions = initBlacklistedFileExtensions();
  ...
  public List<String> initBlacklistedFileExtensions() {
  ...
  public List<String> initBlacklistedFolders() {
